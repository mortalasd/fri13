...
fn updateGameState() void {
    ...
    switch (game_state) {
        0 => {
            setText(100, "FRI13", FPVec2.init(hero.x, hero.y - (96 << fbits)), colors.blood_light, 16);
            setText(101, "TAP TO START", FPVec2.init(hero.x, hero.y + (24 << fbits)), colors.paper, 4);
            setText(102, "twitter.com/FRI13xSOL\n\nt.me/FRI13xSOL\n&\nCA:", FPVec2.init(hero.x, hero.y + (64 << fbits)), colors.paper, 2);
